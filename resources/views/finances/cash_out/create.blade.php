...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item active">{{ Breadcrumbs::render('create_cash_out') }}</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<!-- general form elements -->
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('finances.store_cash_out') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cash_out" id="cash_out" class="form-control @error('cash_out') is-invalid @enderror" placeholder="Masukan nominal" value="{{ $student->cash_out ?? old('cash_out') }}">
                            @error('cash_out')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
<script type="text/javascript">
	var masuk = document.getElementById('cash_out');
