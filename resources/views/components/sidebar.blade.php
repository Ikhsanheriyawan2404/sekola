...
<a href="{{ route('home', []) }}" class="brand-link">
    <img src="{{ $setting->takeImage }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">{{ $setting->school_name ?? 'SMK N 1 Suzuran'}}</span>
    {{-- <span class="brand-text font-weight-light">SMK N 1Suzuran</span> --}}
</a>
    <!-- Sidebar -->
    <div class="sidebar">
